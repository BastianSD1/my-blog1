...
localStorage.getItem = user_name room_name ;
...
function getData() { 
  ...
  getData()
  function uptadelike(message_id) {
console.log("presiono el boton me gusta" + message_id)
button_id = message_id
likes =document.getElementById(button_id).value;
uptadedlikes = number(likes) + 1;
console.log= (uptadedlikes);

firebase.database().ref(room_name).child(message_id).uptade({
  like: uptaded_likes
})
...
window.location.replace("kwiter.html");
  }
